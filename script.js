  ...
  tabletopia: {
    ...
    troubleshooting: [
      ...
      },
      {
        ...
        rows: [
          { label: '문제', text: '다수 사용자 동시 접근 시 중복 예약 가능성, RDBMS 단독 처리 시 트랜잭션 충돌 가능.' },
          { label: '해결', text: 'Redis SETNX을 이용하여 동시 요청이 들어와도 반드시 하나만 성공하도록 좌석 선점 설계. TTL 5분으로 미결제 좌석 자동 해제.' },
          { label: '결과', text: '데이터 무결성 보장 및 결제 대기 5분 동안 DB 락을 걸지 않아 DB 부하를 최소화.' },
        ],
      },
    ],
  },
